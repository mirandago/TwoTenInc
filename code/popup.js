var DEFAULT_FOCUS_TEXT = "Focus";
var DEFAULT_BREAK_TEXT = "Break";
...
class TimerDisplay {
    ...
    updateTimerDisplay(timer) {
        ...
        if (timer.isFocus) {
            ...
            document.getElementById(this.stateContainerId).style.backgroundColor = "blue";
        } else {
            document.getElementById(this.stateTextId).innerText = DEFAULT_BREAK_TEXT;
            document.getElementById(this.stateContainerId).style.backgroundColor = "green";
        }
    }
}

// timer dsiplay variable
var timerDisplay = new TimerDisplay("timer", "play_img", "pause_img", "timer_state", "rcorners");
